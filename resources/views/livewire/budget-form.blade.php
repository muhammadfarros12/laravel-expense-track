<div class="min-h-screen bg-gray-50 dark:bg-neutral-900 rounded">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <div class="relative bg-gradient-to-br from-purple-50 via-indigo-50 to-blue-50 border-2 border-purple-200 rounded-xl p-6 shadow-lg">
                  ...
                  <div class="grid grid-cols-3 gap-4 mb-4">
                      <button type="button"
                          ...
                          <p class="text-2xl font-bold text-gray-900">Rp{{ number_format($aiRecommendation['min'], 0) }}</p>
                      </button>
                      ...
                      <button type="button"
                          ...
                          <p class="text-2xl font-bold">Rp{{ number_format($aiRecommendation['recommended'], 0) }}</p>
                      </button>
                      ...
                      <button type="button"
                          ...
                          <p class="text-2xl font-bold text-gray-900">Rp{{ number_format($aiRecommendation['max'], 0) }}</p>
                      </button>
                  </div>
        ...
        <div class="p-4 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg border-2 border-indigo-200">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-2xl font-bold text-indigo-900">Rp{{ number_format($amount, 2) }}</p>
                    <p class="text-sm text-indigo-700">
                        {{ $category_id ? optional($categories->find($category_id))->name ?? 'Selected Category' : 'Overall Budget' }}
                    </p>
                </div>
                <div class="text-right">
                    ...
                    <p class="text-xs text-indigo-600 mt-1">
                        ≈ Rp{{ number_format($this->dailyAmount($amount, $month, $year), 2) }}/day
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="mt-8 bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="p-4 bg-gray-50 rounded-lg">
                        ...
                        <p class="text-sm text-gray-600">Recommended: Rp2.000.000 – Rp3.500.000 / bulan</p>
                        <p class="text-xs text-gray-500 mt-1">Termasuk belanja kebutuhan pokok, makan di luar, dan kopi</p>
                    </div>

                    <div class="p-4 bg-gray-50 rounded-lg">
                        <p class="font-semibold text-gray-900 mb-2">🚗 Transportation</p>
                        <p class="text-sm text-gray-600">Recommended: Rp800.000 - Rp1.800.000 / bulan</p>
                        <p class="text-xs text-gray-500 mt-1">Bensin, transport online, servis berkala, atau transport umum</p>
                    </div>

                    <div class="p-4 bg-gray-50 rounded-lg">
                        <p class="font-semibold text-gray-900 mb-2">🎬 Entertainment</p>
                        <p class="text-sm text-gray-600">Recommended: Rp300.000 - Rp800.000 / bulan</p>
                        <p class="text-xs text-gray-500 mt-1">Hobi, nonton, langganan streaming, dan aktivitas rekreasi</p>
                    </div>

                    <div class="p-4 bg-gray-50 rounded-lg">
                        <p class="font-semibold text-gray-900 mb-2">🛒 Shopping</p>
                        <p class="text-sm text-gray-600">Recommended: Rp400.000 - Rp1.200.000 / bulan</p>
                        <p class="text-xs text-gray-500 mt-1">Belanja pakaian, elektronik kecil, dan kebutuhan rumah tangga</p>
                    </div>
