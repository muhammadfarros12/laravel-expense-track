    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-xl dark:bg-gray-700 shadow-md overflow-hidden">
                    <div class="p-6 border-b border-gray-200">
                        <h3 class="text-lg font-semibold dark:text-gray-400 text-gray-800">Your Categories</h3>
                        <p class="text-sm text-gray-600 dark:text-gray-300 mt-1">{{ $categories->count() }} category
                        </p>
                    </div>
                    ...
                    @if ($categories->count() > 0)
                        <div class="divide-y devide-gray-200">
                            @foreach ($categories as $category)
                                <div class="p-6 hover:bg-gray-50 dark:hover:bg-gray-600 transition"
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center gap-4 flex-1">
                                            ...
                                            <div class="flex-1">
                                                <h4 class="text-lg font-semibold dark:text-gray-400 text-gray-900">
                                                    {{ $category->name }}</h4>
                                        ...
                                        <div class="flex items-center gap-2">
                                            <button wire:click='edit({{ $category->id }})'
                                                class="p-2 rounded-lg dark:text-gray-300 hover:text-green-600 hover:bg-green-50 rounded-lg transition">
                                            ...
                                            @if ($category->expenses_count == 0)
                                                <button wire:click='delete({{ $category->id }})'
                                                    ...
                                                    class="p-2 rounded-lg dark:text-gray-300 hover:text-red-600 hover:bg-red-50 rounded-lg transition">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                        class="size-6">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
