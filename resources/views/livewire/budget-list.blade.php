    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-400">Rp{{ number_format($totalBudget, 2, ',', '.') }}</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold {{ $totalRemaining < 0 ? 'text-red-600' : 'text-green-600' }}">
                        Rp{{ number_format(abs($totalRemaining), 2, ',', '.') }}
                        @if ($totalRemaining < 0)
                    ...
                    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition"
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <span
                                    class="text-2xl font-bold text-gray-900">Rp{{ number_format($budget->amount, 2, ',', '.') }}</span>
                            </div>
                            ...
                            <div class="pt-2 border-t border-gray-200 space-y-2">
                                <div class="flex items-center justify-between text-sm">
                                    ...
                                    <span
                                        class="font-semibold text-gray-900">Rp{{ number_format($budget->spent, 2, ',', '.') }}</span>
                                </div>
                                <div class="flex items-center justify-between text-sm">
                                    ...
                                    <span
                                        ...
                                        @if ($budget->remaining >= 0)
                                            Rp{{ number_format($budget->remaining, 2, ',', '.') }}
                                        @else
                                            -Rp{{ number_format(abs($budget->remaining), 2, ',', '.') }}
                                        @endif
                                    </span>
                                </div>
                            </div>
        ...
        @else
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-12 text-center">
                ...
                <p class="text-gray-600 dark:text-gray-300 mb-6">Create budgets to track your spending and stay on
                    target
